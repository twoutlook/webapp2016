...
//    width: 550,
    ...
    initComponent: function () {
        ...
        Ext.grid.dummyData = [
            [1, "中文Adam Featherstone", "adam@gmail.com", "第三個欄位adam@gmail.com"],
        ...
        this.contactGrid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: "備註", width: 200, dataIndex: 'rem'}
                
            ],
            columnLines: true,
            listeners: {
                afterrender: function () {
                    var cellJson = SHEET_API.getCellValue(SHEET_API_HD, this.sheetId, this.row, this.col);
